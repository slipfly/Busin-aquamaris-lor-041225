...
export function createIndex(done) {
    let str =
        ...
        ${data.project_title}
        </title></head><body style="margin: 0; padding: 0; display: flex; align-items: center; justify-content: center;">
        <iframe src="./slide_0/index.html" frameborder="0" width="1280" height="768" allowfullscreen></iframe>
    </body></html>`;
